# -*- coding: utf-8 -*-
"""prediction model 2.0 3rd MILESTONE.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zjezraGVgC32LU33eGHt5EylDvL0xiNj
"""
...
# try:
#     model = joblib.load('/content/drive/MyDrive/infosys ai/model.joblib')
...
# budget = st.number_input("movie_Budget", min_value=0.0, value=0.0, step=1000000.0)
...
# selected_languages = st.multiselect("Movie_Languages", languages)
# selected_countries= st.multiselect("Movie_Countries", countrys)
# overview = st.text_input("Overview")
# crew_info = st.text_input("Crew")
# cast_info = st.text_input("Cast")
# 
# status_options = {
#         3: 'Released',
#         2: 'Post Production',
